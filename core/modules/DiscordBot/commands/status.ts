...
export const generateStatusMessage = (
    ...
    //RUSTTODO: Server join URL generation depends on server address configuration
    const serverAddress = txCore.cacheStore.get('fxsRuntime:serverAddress') ?? 'localhost:28015';
    ...
    const placeholders = {
        ...
        statusColor: '#4C3539',
        serverAddress,
        serverBrowserUrl: `steam://run/258550/`,
        serverJoinUrl: `steam://connect/${serverAddress}`,
