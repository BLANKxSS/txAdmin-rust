...
export default () => {
    ...
    */
    ...
    //Plugins routes
    router.get('/plugins', apiAuthMw, routes.plugins_getData);
    router.post('/plugins/sync', apiAuthMw, routes.plugins_syncCatalog);
    router.post('/plugins/install', apiAuthMw, routes.plugins_install);
    router.post('/plugins/uninstall', apiAuthMw, routes.plugins_uninstall);
    router.post('/plugins/reload', apiAuthMw, routes.plugins_reload);

    //Oxide Groups routes
    router.get('/oxideGroups', apiAuthMw, routes.oxideGroups_getData);
    router.post('/oxideGroups', apiAuthMw, routes.oxideGroups_actions);
