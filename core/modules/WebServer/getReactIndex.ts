...
export default async function getReactIndex(ctx: CtxWithVars | AuthedCtx) {
    ...
    const injectedConsts: InjectedTxConsts = {
        ...
        isConfigured: txManager.configState === TxConfigState.Ready,
    ...
    replacers.ogDescripttion = escapeHtmlAttribute(`Manage & Monitor your Rust Server with txAdmin v${txEnv.txaVersion}`);
