...
export class ServerPlayer extends BasePlayer {
    ...
    constructor(
        ...
        //NOTE: Rust players have no FiveM license identifier, so the steam id (hex) is
        //used as the database key instead, keeping all db/history/ban machinery working.
        this.license = validIdsObject.license ?? validIdsObject.steam;
