...
export {
    getPluginsData as plugins_getData,
    syncPluginsCatalog as plugins_syncCatalog,
    installPlugin as plugins_install,
    uninstallPlugin as plugins_uninstall,
    reloadPlugin as plugins_reload,
} from './plugins';

export {
    getOxideGroupsData as oxideGroups_getData,
    oxideGroupsActions as oxideGroups_actions,
} from './oxideGroups';
