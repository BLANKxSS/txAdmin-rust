...
//RUSTTODO: Rust server version validation (not needed for standalone Rust)
const fxsVersion = 99999;
...
//RUSTTODO: Rust server path (fxsCitizenRoot kept for compatibility)
...
let dataPath = cleanPath('D:/RustServer/txData');
...
//RUSTTODO: Rust server display version tag
let fxsVersionTag = 'Rust/Win';

//Provider tag logic (keep harmless for Rust)
let providerTag = '';
