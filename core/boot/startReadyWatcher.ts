...
const getOSMessage = async () => {
    ...
    //RUSTTODO: message adapted for Rust dedicated server
    const winWorkstationMessage = [
        '[!] Home-hosting a Rust server is not recommended [!]',
        'You need to open the Rust server ports (usually 28015-28017) on Windows Firewall',
