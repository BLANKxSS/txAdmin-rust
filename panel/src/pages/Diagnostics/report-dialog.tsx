...
const InfoContent = () => (
    <div className="space-y-4 text-sm">
        <p className="text-sm">
            This <u>optional</u> feature sends a diagnostics report to the txAdmin support team, and may be required to diagnose a wide range of server issues.
        ...
        <div className="space-y-4">
            <div>
                ...
                <p>
                    The data will be available for up to 24 hours to the support team.
                </p>
            </div>
