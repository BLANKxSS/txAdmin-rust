 ...
 * Constants
 */
//Rust servers are healthy at 30+ fps (33ms/tick); slower than that reads as lag.
const PERF_MIN_TICK_TIME = {
    svMain: (1000 / 30) / 1000,
    //unused on Rust, kept for type compat
                ...
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        <SelectContent className="px-0">
                            {/* Rust has a single server thread we can measure */}
