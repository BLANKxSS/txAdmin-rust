...
const allRoutes: RouteType[] = [
    ...
    },
    {
        path: '/server/setup',
        title: 'Server Setup',
        permission: 'master', //FIXME: eithger change to all_permissions or create a new Setup permission
    ...
    {
        path: '/server/plugins-browse',
        title: 'Browse Plugins',
        permission: 'commands.resources',
        Page: <PluginsBrowsePage />
    },
    {
        path: '/server/groups',
        title: 'Groups',
        permission: 'server.groups',
        Page: <OxideGroupsPage />
    },
    {
        path: '/advanced',
        title: 'Advanced',
