...
import { ClipboardCheckIcon, DoorOpenIcon, ListIcon, PieChartIcon, ScrollIcon, SettingsIcon, ShieldIcon, UserSquare2Icon, UsersIcon, ZapIcon } from 'lucide-react';
                ...
                <ScrollArea className="h-full px-6 [&_svg]:shrink-0">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-wrap flex-row xs:grid grid-cols-2 gap-4">
                            ...
                            <MenuNavLink href="/server/groups" disabled={!hasPerm('server.groups')}>
                                <ShieldIcon className="mr-2 h-4 w-4" />Groups
                            </MenuNavLink>
