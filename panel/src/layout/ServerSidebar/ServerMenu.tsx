...
import { ChevronRightSquareIcon, DnaIcon, EyeIcon, FileEditIcon, HourglassIcon, LayoutDashboardIcon, PuzzleIcon, SearchIcon, ShieldIcon } from 'lucide-react';
    ...
    return <div className='relative'>
        ...
        <div className={cn(isConfigPending && 'opacity-0 pointer-events-none')}>
            ...
            <div className="space-y-1 select-none">
                ...
                <MenuNavLink href="/server/plugins" disabled={!hasPerm('commands.resources')}>
                    <PuzzleIcon className="mr-2 h-4 w-4" />Plugins
                </MenuNavLink>
                <MenuNavLink href="/server/plugins-browse" disabled={!hasPerm('commands.resources')}>
                    <SearchIcon className="mr-2 h-4 w-4" />Browse Plugins
                </MenuNavLink>
